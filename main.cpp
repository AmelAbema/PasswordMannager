...
void search(const std::vector<Password>&);
void addPassword(std::vector<Password>&, std::vector<std::string>&);
void deletePassword(std::vector<Password>&);
void editPassword(std::vector<Password>&, std::vector<std::string>&);
std::string addCategory(std::vector<std::string>&);
void deleteCategory(std::vector<std::string>&, std::vector<Password>&);
void sortPasswords(std::vector<Password>&);
int menu();
...
int main() {
    ...
    for (auto pass : *passwords) {
        output_file << pass.toEncryptedString();
    }
